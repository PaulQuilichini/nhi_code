...
- Don't make one-off patches if the same problem exists in other areas. Systemic fixes are better, but should be okayed by the user first once identified.
...
**5. Strict adherence to first principals -> absolutely no patches where a clean and complete fix is more appropriate. 
